...
public class MTCNN {
    ...
    public MTCNN(Context context) throws IOException {
        ...
        pInterpreter = new Interpreter(MyUtil.loadModelFile(context, MODEL_FILE_PNET), options);
        rInterpreter = new Interpreter(MyUtil.loadModelFile(context, MODEL_FILE_RNET), options);
        oInterpreter = new Interpreter(MyUtil.loadModelFile(context, MODEL_FILE_ONET), options);
    }
